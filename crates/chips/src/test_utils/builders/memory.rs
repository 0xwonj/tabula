...
use crate::state_column::StateColumnRow;
use crate::state_column::trace::EntrySource;
...
impl InterTxOrderRowBuilder {
    ...
    /// Consume the builder and produce the `InterTxOrderRow`.
...
impl StateColumnRowBuilder {
    ...
    /// Mark segment as touched.
    pub fn touched(mut self) -> Self {
        self.inner.segment_is_touched = true;
        self
    }

    /// Consume the builder and produce the `StateColumnRow`.

...
/// Structured event recorded during a capability call.
...
pub struct CapabilityCallEvent {
    ...
    /// Input values passed to the capability.
...
pub enum TxResult {
    ...
    Success {
        ...
        /// Capability call events recorded during this transaction.
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        capability_events: Vec<CapabilityCallEvent>,

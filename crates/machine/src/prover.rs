...
pub fn prove<CS: StarkAir>(
    ...
    for (idx, instance) in instances.iter().enumerate() {
        ...
        assert!(
            ...
            "chip '{}' trace height {} is not a power of two",
            chip_id,
            height
        );
...
pub fn prove_default<CS: StarkAir>(traces: &TraceMap, statement: PublicStatement) -> TabulaProof {
    prove::<CS>(&default_config(), traces, statement)
}
...
fn compute_chip_records<CS: StarkAir>(
    ...
    traces: &TraceMap,
) -> Vec<tabula_stark::debug::ChipRecord<BabyBear>> {

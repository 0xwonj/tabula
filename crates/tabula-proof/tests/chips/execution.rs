...
use crate::common::builders::{
    make_add, make_and, make_assert, make_not, make_or, make_read, make_read_then_add, make_select,
    make_sub, make_write,
};
...
#[test]
fn standard_width() {
    // 121 (old) + 49 (3 × 16 selectors + 1 null flag) = 170
    assert_eq!(EXECUTION_STANDARD_WIDTH, 170);
}

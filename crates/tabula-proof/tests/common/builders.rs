...
pub fn make_add(dst_slot: usize, src1: u64, src2: u64) -> InstructionRecord {
...
pub fn make_sub(dst_slot: usize, src1: u64, src2: u64) -> InstructionRecord {
...
pub fn make_assert(src_val: bool) -> InstructionRecord {
    InstructionRecord {
...
pub fn make_select(dst_slot: usize, cond: bool, if_true: u64, if_false: u64) -> InstructionRecord {
...
pub fn make_not(dst_slot: usize, src: bool) -> InstructionRecord {
    InstructionRecord {
        opcode: Opcode::Not,
        tx_index: 0,
        written_slots: vec![dst_slot],
...
pub fn make_and(dst_slot: usize, a: bool, b: bool) -> InstructionRecord {
    InstructionRecord {
        opcode: Opcode::And,
        tx_index: 0,
        written_slots: vec![dst_slot],
...
pub fn make_or(dst_slot: usize, a: bool, b: bool) -> InstructionRecord {
    InstructionRecord {
        opcode: Opcode::Or,
        tx_index: 0,
        written_slots: vec![dst_slot],

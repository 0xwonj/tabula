...
use tabula_proof::chips::execution::{InstructionRecord, Opcode};
...
use tabula_proof::chips::smt_path::trace::{SmtPathWitness, SmtTablePathWitness};
use tabula_proof::chips::state_column::air::StateColumnChip;
use tabula_proof::debug::debug_check;
use tabula_proof::trace::{

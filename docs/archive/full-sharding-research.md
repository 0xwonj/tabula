...
> **Related**: [proof-hierarchy-and-grouping.md](proof-hierarchy-and-grouping.md), [sharded-protocol-design.md](sharded-protocol-design.md), [commitment-architecture-research.md](commitment-architecture-research.md), [proof-optimization-architecture.md](proof-optimization-architecture.md)

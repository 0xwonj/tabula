...
> Related: [proof-hierarchy-and-grouping.md](proof-hierarchy-and-grouping.md), [full-sharding-research.md](full-sharding-research.md), [sharded-protocol-design.md](sharded-protocol-design.md)
